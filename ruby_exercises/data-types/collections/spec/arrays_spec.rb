...
RSpec.describe 'Arrays' do
  ...
  it 'test 12' do
    ...
    new_scores = scores.insert(-1,scores.delete_at(0)).insert(-1,scores.delete_at(0))
    puts new_scores
    ...
    new_scores = scores.insert(0, scores.delete_at(2)).insert(1, scores.delete_at(3)).insert(2, scores.delete_at(-1))
    puts new_scores 
